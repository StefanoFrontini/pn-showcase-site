...
/**
 * Shared styling for the dashboard filter `<Select>`s (tipologia ente, andamento
 * notifiche, mappa). Fixes the accessibility issues reported on the "SEND in
 * numeri" page (ticket A2-460 / WCAG 1.4.1, 1.4.3, 1.4.11):

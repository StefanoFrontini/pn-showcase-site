...
const NotificationsTrendLineChart = ({ filterSignal, yearSignal }: Props) => {
  ...
  useEffect(() => {
    ...
    embed(chartContent.current, lineChartSpec as TopLevelSpec, chartConfig)
      .then(setChart)
      .catch(console.error);
  }, []);
...
export default NotificationsTrendLineChart;
